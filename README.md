...
- `@ethersproject-bsc/experimental` ([documentation](https://docs.ethers.io/v5/api/experimental/))
- `@ethersproject-bsc/cli` ([documentation](https://docs.ethers.io/v5/cli/))
- `@ethersproject-bsc/hardware-wallets` ([documentation](https://docs.ethers.io/v5/api/other/hardware/))
